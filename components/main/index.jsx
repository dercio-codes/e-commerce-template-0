    ...
    >
      <Grid container>
        <Grid item xs={12} lg={6}>
          ...
          >
            {" "}
            Tired of missing out on new merch?{" "}
          </Typography>
          <Box sx={{ display: "flex", alignItems: "center", background: "" }}>
            <TextField
              ...
              sx={{ width: { xs: "100%", md: "370px" }, padding: "16px 0" }}
...
*/}
      ...
      >
    	...
    	*/}
        ...
        <Box
          sx={{ height: "350px", width: "250px", background: "", margin: "0" }}
        >
          <svg
            version="1.1"
          ...
          >
            <defs>
              <linearGradient id="gradient" x1="0%" y1="0%" x2="0%" y2="100%">
                <stop
                  offset="0%"
                  style={{ stopColor: Theme["FOURTH_COLOR"] }}
                ></stop>
                <stop
                  offset="100%"
                  style={{ stopColor: Theme["FIFTH_COLOR"] }}
                ></stop>
              </linearGradient>
            </defs>
