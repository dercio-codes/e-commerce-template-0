        ...
        >
          ...
          <Grid container>
            <Grid
              ...
              xs={12}
              lg={6}
              sx={{ background: "", padding: "12px 21px" }}
            >
              <Typography
                sx={{
                  fontSize: "28px",
              ...
              >
                ...
                >
                  {" "}
                  Click Here To Sign {signIn ? "Up" : "In"}{" "}
                </Typography>{" "}
              </Typography>
            </Grid>
            <Grid
            ...
            >
              ...
              <img
                src="https://cdn-icons-png.flaticon.com/512/1968/1968666.png"
                alt=""
                style={{
                  opacity: 1,
                  margin: "34px 0",
              ...
              <Box sx={{ padding: "21px 0" }}>
                ...
                >
                  <img
                    ...
                    src="   https://www.transparentpng.com/download/facebook-logo/facebook-icon-transparent-background-20.png"
                    alt=""
                  />
                ...
                >
                  <TwitterIcon sx={{ margin: "0 12px", fontSize: "34px" }} />{" "}
