...
<Box sx={{ display:'flex' , alignItems:'center' }}>
		<Avatar src="" sx={{ width:{xs:'60px' , md:'120px'} , height:{xs:'60px' , md:'120px'}  }} />
		<Typography sx={{ fontSize:'32px',margin:'0 21px' , color:Theme["FOURTH_COLOR"] , padding:'0 0' , fontWeight:'400' }}> John Doe. </Typography>
</Box>

<Box sx={{ display:'flex' , alignItems:'center' , padding:'34px 0' }}>
         {
         	tabs.map(item => <Button onClick={()=>setSelected(item)} key={item} variant="outline" sx={{ border:'1px solid #black', background:selected === item ? Theme["FOURTH_COLOR"] : "" , color:selected === item ? '#eee' : Theme["FOURTH_COLOR"]  }}>{item}</Button>)
         }
...
<Box sx={{ width:{ xs:'100%', lg:'40%'} , padding:' 0' , background:'' , display:selected === "Orders" ? 'flex' : "none",
...

    		{
    			images.map((item , index)=>{
    				return(
    		<Paper key={item} sx={{ width:{ xs:'49%',  lg:'100%'}, display:'flex', flexDirection:{xs:'column' , md:''}, minHeight:'120px' , padding:'8px', margin:'24px 0',background:'transparent' }} >
    		...
    		<Button sx={{ background:Theme["FOURTH_COLOR"],padding:'16px 21px' , margin:'0px' ,color:'#eee', width:'100%', height:'95px' , fontWeight:600 , "&:hover":{color:Theme["FOURTH_COLOR"]} }}>Remove from Cart</Button>
...
<Box sx={{ width:{ xs:'100%', lg:'55%'} , padding:' 0' , background:"rgba(1,1,1,.7)" , display:selected === "Cart" ? 'flex' : "none",

    		flexWrap:'wrap', }} >

    	<Box sx={{ width:'100%' , background:'' , padding:'34px' }}>
    		<Typography sx={{ fontSize:'32px' , color:"#eee" , padding:'1px 0' , fontWeight:'600' }}> Checkout </Typography>
	<TextField sx={{ width:{ xs:'100%'} , padding:'16px 0' }}  placeholder={"Name"}/>
	<TextField sx={{ width:{ xs:'100%'} , padding:'16px 0' }}  placeholder={"Surame"}/>
	<TextField sx={{ width:{ xs:'100%'} , padding:'16px 0' }}  placeholder={"Email"}/>
	<TextField sx={{ width:{ xs:'100%'} , padding:'16px 0' }}  placeholder={"Phone Number"}/>
	<TextField sx={{ width:{ xs:'100%'} , padding:'16px 0' }}  placeholder={"Address"}/>
	<TextField sx={{ width:{ xs:'100%'} , padding:'16px 0' }}  placeholder={"House Type"}/>
	<TextField sx={{ width:{ xs:'100%'} , padding:'16px 0' }}  placeholder={"City"}/>
	<TextField sx={{ width:{ xs:'100%'} , padding:'16px 0' }}  placeholder={"State/Province"}/>
    		
    		<Box sx={{

    			backgroundImage:'url("https://paystack.com/assets/payment/img/paystack-badge-cards-zar.png")',
    		...
    		<Button sx={{ background:Theme["FOURTH_COLOR"],padding:'16px 21px' , margin:'0px' ,color:'#eee' , width:'100%' , fontWeight:600 , "&:hover":{color:Theme["FOURTH_COLOR"]} }}>Pay Now</Button>
...
<Box sx={{ width:'100%' , padding:' 0' , background:"" , display:selected === "Wishlist" ? 'flex' : "none",
...
<Box sx={{ display:'' , width:'100%' }}>
        <Button  sx={{ background:Theme["FOURTH_COLOR"],padding:'16px 12px' , margin:'0 3px' ,color:'#eee' , width:'100%' ,fontWeight:600, "&:hover":{color:Theme["FOURTH_COLOR"]} }}>Remove from wishlist</Button>
</Box>
